...
\ea%4
    ...
    \gll    \textit{videla volk-e}\\
            saw  wolf-\textsc{[non-nom]}\\
    \glt    ‘(she) saw a wolf’
    \ex
    \label{ex:01:4b}
    \gll    \textit{onak su videli krevet-a}\\
            then  be-\textsc{3.SG.AUX}  see-\textsc{3.SG.AUX}  bed-\textsc{non[nom]}\\
